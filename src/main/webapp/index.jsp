    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Tunbor</a>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 col-sm-6">
            <div class="showcase-left">
               <%--<img src="<c:url value='/resources/img/image1.jpg' />" alt="Image 1" > --%>        
                <img src="<c:url value='/resources/img/ipho.png' />" alt="Image 1" >        
            </div>
          </div>
          <div class="col-md-6 col-sm-6">
    ...
    <section id="info1">
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-sm-6">
            <div class="info-left">
              <img src="<c:url value='/resources/img/image2.png' />" alt="Image 2" >  
            </div>
          </div>
          <div class="col-md-6 col-sm-6">
